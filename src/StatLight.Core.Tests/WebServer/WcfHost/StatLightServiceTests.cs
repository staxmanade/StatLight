    ...
    namespace StatLightServiceTests
    {
        ...
        public class when_using_an_instance_of_the_StatLightService_that_is_initialized_with_filtering_options : using_a_random_temp_file_for_testing
        {
            ...
            protected override void Before_all_tests()
            {
                ...
                var config = new ClientTestRunConfiguration(UnitTestProviderType.MSTest, new Collection<string>(), _tagFilter, 1, "", StatLight.Core.WebBrowser.WebBrowserType.SelfHosted, false, string.Empty);
