...
namespace StatLight.Core.Tests.Runners
{
    ...
    //    private ContinuousConsoleRunner CreateContinuousTestRunner()
    //    {
    ...
    //        var statLightConfiguration = new StatLightConfiguration(clientTestRunConfiguration, serverTestRunConfiguration);
    //        var responseFactory = new ResponseFactory(statLightConfiguration.Server.HostXap, clientTestRunConfiguration);
    //        var runner = new ContinuousTestRunner(TestLogger, TestEventSubscriptionManager, TestEventPublisher, _mockWebBrowser.Object, new[] { statLightConfiguration }, responseFactory);
    //        return runner;
    //    }
...
//                                                                            forceBrowserStart: true,
//                                                                            windowGeometry: new WindowGeometry());
//            var statLightConfiguration = new StatLightConfiguration(_clientTestRunConfiguration, serverTestRunConfiguration);

//            var responseFactory = new ResponseFactory(statLightConfiguration.Server.HostXap, _clientTestRunConfiguration);


//            _continuousTestRunner = new ContinuousTestRunner(TestLogger, TestEventSubscriptionManager, TestEventPublisher, _mockWebBrowser.Object, new[] { statLightConfiguration }, responseFactory);
