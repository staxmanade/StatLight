...
namespace StatLight.Client.Silverlight.UnitTestProviders.UnitDriven
{
	...
	/// metadata.
	/// </summary>
	public class UnitDrivenTestProvider : IUnitTestProvider
	{
		/// <summary>
		/// Name of this provider.
		/// </summary>
		private const string ProviderName = "UnitDriven";
		...
		public bool IsFailedAssert(Exception exception)
		{
			...
			return et.FullName.Contains("UnitDriven.TestException");
		}
