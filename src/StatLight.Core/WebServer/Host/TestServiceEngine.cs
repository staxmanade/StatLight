...
namespace StatLight.Core.WebServer.Host
{
    ...
    public class TestServiceEngine : IWebServer
    {
        ...
        public TestServiceEngine(string machineName, int port, TimeSpan shutdownDelay)
        {
...
files, folders, and other information.
        ...
        private static void ServeCrossDomainFile(HttpListenerResponse response)
        {
            ...
            ServeString(response, Resources.ClientAccessPolicy);
        }
        ...
        public void Start()
        {
            _serverListener = new Thread(ServeRequests);
            _serverListener.Start();
        }

        public void Stop()
        {
            this.BeginShutdownProcess();
